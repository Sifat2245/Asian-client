...
const OrderTableRow = ({ order }) => {
    ...
    return (
        <>
            ...
            {editModalOpen && (
                <div className="fixed inset-0 bg-[#00000070] bg-opacity-75 flex justify-center items-center z-50 p-4">
                    <div className="bg-white rounded-2xl p-8 md:p-10 w-full max-w-4xl max-h-[95vh] overflow-y-auto shadow-2xl relative">
                        {/* Close Button */}
                        <button
